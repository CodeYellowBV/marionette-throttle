(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["marionette-throttle"] = factory();
	else
		root["marionette-throttle"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backboneMarionette = __webpack_require__(1);
	...
	exports['default'] = _backboneMarionette2['default'].Behavior.extend({
	    defaults: {
	        methods: [],
	        className: 'throttled'
	    },
	            ...
	            _this.view[method] = (function (original) {
	                return function (e) {
	                    if (_this.isEnabled[method]) {
	                        var _ret = (function () {
	                            var xhr = original.apply(_this.view, _arguments);
	                            var $el = null;
